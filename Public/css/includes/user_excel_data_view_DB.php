...
/*
 *  excel 导入设置－－数据浏览
 *  $HeadURL: https://192.168.0.101/svn/ehr/trunk/eHR/ess/includes/user_excel_data_view_DB.php $
 *  $Id: user_excel_data_view_DB.php 2197 2009-09-23 05:41:09Z boll $
 *  $Rev: 2197 $ 
 *  $Date: 2009-09-23 13:41:09 +0800 (周三, 23 九月 2009) $
 *  $Author: boll $   
 *  $LastChangedDate: 2009-09-23 13:41:09 +0800 (周三, 23 九月 2009) $
 *********************************************************/
...
class Umd extends AresAction 
{
	...
	public function actionList()
	{
		$sql = "select 
				      *
			     from EHR_UPLOAD_DATA
			     where COMPANY_ID='".$_SESSION['user']['company_id']."'
				     and   EMP_ID='".$_SESSION['user']['emp_id']."'
				     and   SETUP_ID='".$_GET['id']."'
			     order by line_no
			     ";
