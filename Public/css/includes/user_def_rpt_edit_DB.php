 ...
 *     
 *  $HeadURL: https://192.168.0.101/svn/ehr/trunk/eHR/ess/includes/user_def_rpt_edit_DB.php $
 *  $Id: user_def_rpt_edit_DB.php 3152 2011-08-01 03:01:19Z dennis $
 *  $Rev: 3152 $ 
...
{
	$g_tpl->assign('rpt_list',$w->getMenu($_POST['module_id'],$_POST['rpt_name']));
}
