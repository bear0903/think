...
<body class="page-container">
	...
	<div class="span-10">
		...
		<table class="bordertable">
			...
			<tr>
				<td>
					<!--<?php echo (default:'休息日'($WEEKEND_DAY_LABEL)); ?>-->
				</td>
				<td>
					<!--<?php echo (default:'工作日'($WORKDAY_LABEL)); ?>-->
				</td>
				<td>
					<!--<?php echo (default:'今天'($CURRENT_DAY_LABEL)); ?>-->
				</td>
				<td>
					<!--<?php echo (default:'未排班'($ARRANGE_LABEL)); ?>-->
				</td>
				<td>
					<!--<?php echo (default:'国定假日'($NATION_DAY_LABEL)); ?>-->
				</td>
			</tr>
		</table>
	</div>
