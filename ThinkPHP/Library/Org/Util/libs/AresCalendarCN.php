<?php
/**
 *  $HeadURL: https://192.168.0.101/svn/ehr/trunk/eHR/libs/AresCalendarCN.php $
 *  $Id: AresCalendarCN.php 698 2008-11-19 05:51:54Z dennis $
 *  $Rev: 698 $ 
 ...
 * @return string
 */
function get_chinese_date($today) {
	###########################################
	#作者: 沈潋(S&S Lab)                      #
	...
	if ($today ["year"] < 1901 || $today ["year"] > 2020)
		die ( "<center><br/><p><b><font color='red'>错误:</font></b>年份只能在 1970 到 2020 之间</p><br/><a href='javascript:history.back();'>返回</a></center>" );
	...
	if ($md > $everymonth [$j] [$i])
		$md -= $everymonth [$j] [$i];
	$nlday = $mday [$md];
	// date("Y年n月j日 ").$weekday[$cur_wday]."<br>".$mten[$everymonth[$j][14]].$mtwelve[$everymonth[$j][15]]."年"
	$nowday = $nlmon . $nlday;
	return $nowday;
}
?> 