 ...
 * @author     Dennis  
 */
require_once 'Input_Abstract.class.php';
class Input_Text extends Input_Abstract
{
    /**
     * Sets or retrieves the maximum number of characters
     * that the user can enter in a text control. 
     *
     * @var int
     */
    public $maxLength;
    ...
    /**
     * Sets or retrieves the value indicated whether 
     * the content of the object is read-only.
     *
     * @var string
     */
    public $readonly;
    ...
    /**
     * must be entry value this filed
     *
     * @var string
     */
    public $isRequired;
     ...
     * @var string
     */
    public $requiredFieldStyle;
    
    /**
     * 栏位值的格式,如果指定格式会自动验证
     * 支持的验证有: 
     *   日期(yyyy-mm-dd hh24:mi:ss | yyyy-mm-dd | hh24:mi:ss)
     *   数字
     *   邮件
     *   电话号码
     *   取值区间(日期和数字)
