 ...
 * @version    $Id:Input_Image.class.php 2797 Jan 7, 2008 11:08:05 AM Dennis $
 */

/**
 * Form Element Input Image
 * 图像 Input 栏位
 * @category   eHR
 * @package    Form
 * @subpackage Input_Image
 ...
 * @author     Dennis 
 */
class Input_Image extends Input_Abstract
{
	protected function _init($config){}
    public function render(){}
    public function output(){}
}// end class Input_Image
?>